...
var mainState = {
  ...
  create: function() {
    ...
    // Timer to add pipes in our game everything 1.5 seconds
  ...
  // Function to add a pipe in the game
  addOnePipe: function(x, y) {
    // Create a pipe at the position x and y
    var pipe = game.add.sprite(x, y, "pipe");

    // Add the pipe top our previously created group
    this.pipes.add(pipe);
